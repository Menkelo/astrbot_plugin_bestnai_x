...
- 单一顶部状态栏显示带阴影的插件 Logo、插件名称及其右侧的服务连接状态，灰字仅保留作者和版本；项目菜单位于清空画布按钮右侧，绿灯表示连接正常，红灯表示连接中断。
...
- 提示词节点提供可展开的“英文 tags”区域，生成或反推后会保存翻译得到的英文 tags；展开状态和节点尺寸会一并保存，修改主提示词时自动清除过期结果。
