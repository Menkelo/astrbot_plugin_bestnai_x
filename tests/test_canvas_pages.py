...
class CanvasPageBridgeTest(unittest.TestCase):
    ...
    def test_library_preloads_and_uses_click_preview_with_drag_placement(self) -> None:
        ...
        self.assertIn('id="assetViewFavoritesBtn"', html)
        self.assertIn('id="assetViewRecentBtn"', html)
        self.assertIn('id="assetAllCount"', html)
        self.assertIn('id="assetFavoritesCount"', html)
        ...
        self.assertIn("function toggleAssetFavorite(item)", editor)
        self.assertIn("function markAssetRecent(item", editor)
        self.assertIn("function renderAssetStackCard(group", editor)
        self.assertIn("groups.some((group) => group.items.length > 1)", editor)
        ...
        self.assertIn(".asset-favorite-btn {", styles)
        self.assertIn(".asset-favorite-btn.active svg", styles)
